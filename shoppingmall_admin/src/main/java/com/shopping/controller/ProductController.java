...
public class ProductController {
    ...
    public String getProduct(Model model){
        ...
        List<CategoryVO> clist = cate_service.cateListAll();
        List<DeliveryVO> dlist = delivery_service.selectDeliveryAll();
        List<SellerInfoVO> slist = seller_service.selectSellerList();
